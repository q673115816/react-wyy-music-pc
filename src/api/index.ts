...
// 独家放送
export const apiPersonalizedPrivatecontent = () =>
...
export const apiPersonalizedNewsong = (params) =>
  post("/personalized/newsong", params);
 ...
 */
export const apiPlaylistSubscribers = (params) =>
  post("/playlist/subscribers", params);
// 收藏/取消收藏歌单 t=1||2 , id
export const apiPlaylistSubscribe = (params) =>
  post("/playlist/subscribe", params);
/**
 *
...
// 推荐歌单 > 登录
export const apiRecommendResource = (params) =>
  post("/recommend/resource", params);
// 推荐歌曲 > 登录
 ...
 */
export const apiTopPlaylistHighquality = (params) =>
  post("/top/playlist/highquality", params);
// 精品歌单标签列表
export const apiPlaylistHighqualityTags = () =>
...
// 朋友 - 话题详情热门动态
export const apiTopicDetailEventHot = (params) =>
  post("/topic/detail/event/hot", params);
// 朋友 - 动态消息
...
export const apiMVExclusiveRcmd = (params) =>
  post("/mv/exclusive/rcmd", params);
 ...
 */
export const apiSearchMultimatch = (params) =>
  post("/search/multimatch", params);
