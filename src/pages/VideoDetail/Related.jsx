          ...
          <div className="cover">
            <Link to={`./${item.vid}`}>
              ...
              <div className="playTime flex-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-player-play" width="12" height="12" viewBox="0 0 24 24" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
