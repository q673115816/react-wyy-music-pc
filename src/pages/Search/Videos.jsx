          ...
          <div className="item" key={item.id}>
            ...
            <div className="footer truncate">
              <Link to={`/player/${type[item.type]}/${item.vid}`}>
                {item.type === 0
                  && (
                  <svg viewBox="0 0 1024 1024" width="24" height="24" className="fill-current" style={{ color: 'var(--themeColor)', verticalAlign: 'top', marginRight: '0.2em' }}>
            ...
            <div className="text truncate text-gray-400">
              by
              &nbsp;
              <Link to={`/user/${item.creator[0].userId}`} className="text-gray-400 hover">
