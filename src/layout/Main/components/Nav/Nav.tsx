...
const CustomLink: FC<CustomLinkProps> = ({
  ...
  <NavLink
    className="flex text-sm p-2 items-center hover:bg-gray-100"
...
export default memo(() => {
  ...
  return (
    <div className={classNames(style.nav, "overflow-auto max-h-full flex-none p-2.5")}>
      ...
      {isLogin && (
        <Playlist name="收藏的歌单" playlist={subscribedPlaylist} />
      )}
    </div>
  );
});
