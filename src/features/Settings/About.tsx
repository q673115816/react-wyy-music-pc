...
const About = () => (
  <>
    ...
    <div className="flex items-center">
      ...
      <a
        href="https://itunes.apple.com/cn/app/wang-yi-yun-yin-le/id590338362?l=ch"
        className="ui_btn inline-flex items-center justify-center border px-3 h-8 rounded-full_small inline-flex items-center justify-center h-6 px-3 rounded-full mr-4"
      >
        <IconBrandApple size={16} className="fill-current" />
        iPhone版
      </a>
      <a
        href="https://itunes.apple.com/cn/app/wang-yi-yun-yin-lehd/id871041757?l=ch"
        className="ui_btn inline-flex items-center justify-center border px-3 h-8 rounded-full_small inline-flex items-center justify-center h-6 px-3 rounded-full mr-4"
      >
        <IconBrandApple size={16} className="fill-current" />
        iPad版
      ...
      <a
        href="http://www.windowsphone.com/s?appid=db9dbdaa-464e-4370-a078-800fc7983d39"
        className="ui_btn inline-flex items-center justify-center border px-3 h-8 rounded-full_small inline-flex items-center justify-center h-6 px-3 rounded-full mr-4"
      >
        <IconBrandApple size={16} className="fill-current" />
        iPhone版
