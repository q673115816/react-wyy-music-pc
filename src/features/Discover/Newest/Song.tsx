...
const DomItem = memo(({ item, index }) => (
  <div
    className={classNames("item h-20 py-2.5 flex items-center px-8 text-sm", {
  ...
  <>
    <div className="domHome_newest_sub_nav">
      ...
      <div className="domHome_newest_sub_control_center space-x-2">
        <button
          type="button"
          className="playAll flex-center ui_theme_bg_color text-white rounded-full px-2 py-0.5"
        >
        ...
        <button
          type="button"
          className="subAll flex-center rounded-full border px-2 py-0.5"
        >
