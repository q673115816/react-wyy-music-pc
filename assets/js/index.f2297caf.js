...
`,Ie=Ae,re={1:"span 12 / span 12",2:"span 6 / span 6",3:"span 4 / span 4",4:"span 3 / span 3"},Ue=({length:e,index:b})=>{if(e%3===0)return re[3];if(e<3)return re[e];let y=e>>1,p=y+(e%2===1&&b>=y?1:0);return re[p]},Ge=C.div`
  position: relative;
  overflow: hidden;
  cursor: pointer;
  border-radius: 1rem;
